...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel" style="background-color: #563d7c;">
            <!-- <div class="row">
            <div class="d-flex justify-content-between"> -->
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a href="" class="nav-link text-white">Decumentation</a>
                        </li>
                        <li class="nav-item">
                            <a href="" class="nav-link text-white">Examples</a>
                        </li>
                        <li class="nav-item">
                            <a href="" class="nav-link text-white">Icons</a>
                        </li>
                        <li class="nav-item">
                            <a href="" class="nav-link text-white">Themes</a>
                        </li>
                        <li class="nav-item">
                            <a href="" class="nav-link text-white">Expo</a>
                        </li>
                        <li class="nav-item">
